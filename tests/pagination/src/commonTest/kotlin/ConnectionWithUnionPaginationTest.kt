...
import pagination.connectionWithUnion.type.buildPageInfo
import pagination.connectionWithUnion.type.buildSomeType
import pagination.connectionWithUnion.type.buildUser
import pagination.connectionWithUnion.type.buildUserConnection
import pagination.connectionWithUnion.type.buildUserEdge
import kotlin.test.Test
import kotlin.test.assertEquals

class ConnectionWithUnionPaginationTest {
  @Test
  fun memoryCache() {
  ...
  private fun errorTest(cacheFactory: NormalizedCacheFactory) = runTest {
    ...
    assertEquals(listOf("someField", "users"), responseFromStore.errors?.firstOrNull()?.path)
  }
}
